...
export default function VisionSection() {
  return (
    <section className='bg-white py-16 px-4 md:px-20'>
      ...
      {/* wrapper: same height as the SVG (150 viewBox → scale however you like) */}
      <div
        className='relative flex'
        style={{
          height:
            '216px' /* 150/200 × 288px = 216px if your SVG is 288px wide */,
        }}
      >
        {/* ───── Pyramid on the left ───── */}
        ...
        {/* ───── Connector lines ───── */}
        {/* each line starts at the right edge of the pyramid (left:18rem) */}
        ...
        {/* ───── Labels ───── */}
        {/* each block is centered on its corresponding line */}
